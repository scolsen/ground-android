...
public class GoogleMapsMapProvider implements MapProvider {
  ...
  @Nullable private SingleSubject<ExtentSelector> extentSelector = SingleSubject.create();
    ...
    ((GoogleMapsFragment) getFragment())
        .getMapAsync(
            googleMap -> {
              ...
              extentSelector.onSuccess(new GoogleMapsMapAdapter(googleMap, fragment.getContext()));
            });
  }
